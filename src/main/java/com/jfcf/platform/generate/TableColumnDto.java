...
public class TableColumnDto {
	...
	public String getColumn_name_t() {
		return column_name_t;
	}
	public void setColumn_name_t(String column_name_t) {
		this.column_name_t = column_name_t;
	}
