...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
     ...
     * 正则表达式：验证URL
     */
    public static final String REGEXP_URL_3 = "http(s)?://([\\w-]+\\.)+[\\w-]+(/[\\w- ./?%&=]*)?";
	/**
	 * 常用正则表达式：匹配中文字符
	 */
	 ...
	 */
	public final static String REGEXP_ACCOUNTNUMBER = "^[a-zA-Z][a-zA-Z0-9_]{6,15}$"; 
     ...
     * 正则表达式：验证手机号
     */
    public static final String REGEXP_MOBILE = "^(13[0-9]|14[0-9]|15[0-9]|16[0-9]|17[0-9]|18[0-9]|19[0-9])\\d{8}$";
	/**
